...
import trunk.social.p2p.dht.StorageLayer;
...
public class Replication implements PeerMapChangeListener, ReplicationListener {
     ...
     * @param nRoot             <code>true</code> for n-root replication, <code>false</code> for 0-root replication
     * @param keepData          flag indicating if data will be kept in memory after loss of replication responsibility
     */
     ...
     *
     * @param responsibilityListener The responsibility listener.
     */
