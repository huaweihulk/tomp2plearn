...
public class AutoReplication implements PeerMapChangeListener, ReplicationFactor {
     ...
     *
     * @param m                    (predicted) number of peers that left the system
     * @param n                    number of all peers
     * @param r                    reliability
     * @param minReplicationFactor the minimal replication factor, not considering the
     *                             reliability
     * @param maxReplicationFactor the maximal replication factor, not considering the
     *                             reliability
     ...
     *
     * @param x The array of independent values, i.e. observations
     * @param y The array of dependent values, i.e. averages
     ...
     *
     * @param observations Array that contains peer departures numbers.
     * @param emas         Array that contains values of exponential moving averages
     ...
     *
     * @param observations   Array that contains recent peer departures numbers.
     * @param currentAverage Current exponential moving average
