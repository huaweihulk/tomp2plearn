...
public class FutureDiscover extends BaseFutureImpl<FutureDiscover> {
    ...
    private PeerSocketAddress.PeerSocket4Address internalAddress;
    
    private PeerSocketAddress.PeerSocket4Address externalAddress;
	...
	public FutureDiscover externalHost(String failed, PeerSocketAddress.PeerSocket4Address internalAddress, PeerSocketAddress.PeerSocket4Address externalAddress) {
		synchronized (lock) {
            if (!completedAndNotify()) {
                return this;
            }
	...
	public PeerSocketAddress.PeerSocket4Address internalAddress() {
        synchronized (lock) {
            return internalAddress;
        }
    }
	
	public PeerSocketAddress.PeerSocket4Address externalAddress() {
        synchronized (lock) {
