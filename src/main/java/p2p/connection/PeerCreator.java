...
public class PeerCreator {
	...
	private static PeerAddress findPeerAddress(final Number160 peerId,
		...
		final PeerSocketAddress.PeerSocket4Address peerSocketAddress = PeerSocketAddress.PeerSocket4Address.builder().ipv4(IP.IPv4.fromInet4Address(outsideAddress))
